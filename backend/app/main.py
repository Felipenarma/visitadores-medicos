...
from .routers import business_lines, reps, doctors, visits, sales, cardex, dashboard, ai_agent, images, mike, knowledge, sessions
...
def run_migrations():
    migrations = [
        ...
        "ALTER TABLE sales ADD COLUMN IF NOT EXISTS categoria VARCHAR(200)",
        "ALTER TABLE sales ALTER COLUMN categoria TYPE VARCHAR(200)",
...
app.include_router(mike.router)
